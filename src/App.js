...
const CONTRACT_ADDRESS = "0x32aa22773364c9f45f27E20642A054De2393e5c0";
...
const App = () => {
  ...
  const Normal = () =>{
    <p className="header gradient-text">これまでに発行されたNFTの数{mintCount}/{maxSupply}</p>
  };
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">発行されたNFTの数{mintCount}/{maxSupply}</p>
          {/*条件付きレンダリング。
          // すでにウォレット接続されている場合は、
          // Mint NFT を表示する。*/}
          {currentAccount === ""
